...
- [ ] Shared baseline rules updated in `skills/.shared/policy/rules/`.
- [ ] Shared baseline rule IDs listed in `skills/.shared/policy/SKILL.md` map to concrete rule definitions.
