...
Research consolidated from `<REPO_ROOT>/specs/001-skill-react-architecture-detection/spec.md`, `<REPO_ROOT>/SPEC.md`, and current skill artifacts to resolve technical-context unknowns and confirm contract decisions before design.
